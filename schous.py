...
# -----------------------------
# INGREDIENT CATEGORIES (standardized)
# -----------------------------
# Note: ingredient unit costs are calculated from Purchases (including freight allocation).
# Categories are used for filtering/analytics and to keep consistent ingredient taxonomy.
            ...
            if not ingredients_df.empty:
                ...
                if selected_ingredient:
                    ...
                    with col_edit1:
                        ...
                        # Keep old categories editable (if they exist) by appending to the standard list
                        current_category = str(ing_data.get("category") or "")
                        category_options = list(INGREDIENT_CATEGORIES)
                        if current_category and current_category not in category_options:
                            category_options = category_options + [current_category]
                        default_idx = (
